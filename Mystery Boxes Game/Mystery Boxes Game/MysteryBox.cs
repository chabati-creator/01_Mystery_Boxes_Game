...
namespace Mystery_Boxes_Game
{
    ...
    {
        private List<int> LOW = new List<int>() { 0, 0, 1, 1, 1, 1, 2, 2, 2, 5};
        private List<int> MEDIUM = new List<int>() { 0, 0, 2, 2, 2, 2, 4, 4, 4, 10};
        private List<int> HIGH = new List<int>() { 0, 0, 3, 3, 3, 3, 6, 6, 6, 15};
